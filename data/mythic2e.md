...
evolving expectations of what happens next.
Expectations
...
GUARD HELP
US?”
CERTAIN You’re as sure ofthis as you can be.
It’s stated its
intent to destroy
us and looks
ready to do so.
...
same team, of
course he’ll help.
LIKELY It’s slightly morelikely than 50/50.It’s armedand angry.
The car appears
to be in working
order.
He seems to be on
...
he’s on. Cross
your fingers.
UNLIKELY It’s slightly lesslikely than 50/50.It’s unarmed anduninterested in us.The vehicle looksa little rough.He hasn’t beentoo friendly.
VERY
UNLIKELY
It’s quite unlikely,
but possible.
...
is facing the challenges of the adventure head-
on and overcoming them. This control over the
...
ANSWER RESULT
YES The answer is Yes, confirmingyour expectation.
EXCEPTIONAL
YES
The answer is Yes,
confirming your
...
FATE CHECK ANSWERS
ROLL TOTAL FATE QUESTION ANSWER
...
for your PC to face.
PC POSITIVE Your PC is having a hard timeand could use a break.
CLOSE A
THREAD
...
elements is a d6, 16-20 elements is a d8, and 21-
25 elements is a d10.
...
way, seemingly trying to attack. For a slow-
moving, slow-witted moss-man, this might be his
...
The same is true in traditional social role-
playing. Your Characters enter a room and deal with
```
...
and Interrupt.
» PLAYING: The content of a Scene -
everything that happens and what your
...
Roll Over
Chaos Factor Expected Scene
```
Roll Odd (1, 3, 5, 7, 9)
```
Within Chaos Factor Altered Scene
```
Roll Even (2, 4, 6, 8)
```
Within Chaos Factor Interrupt Scene
6767
SCENES
...
story restaurant with plenty of people inside
...
up with a suitable mishap. Since this is a GM-
less solo adventure, the Player asks the Fate
...
```
few hours later; if the Player wanted a location-
```
based transition, then the Scene could end when
...
solo or GM-less adventure is by asking conflict-
oriented Questions. Such Questions may be
...
Most of the Elements Meaning Tables are self-
explanatory—for instance, the Creature Descriptors
...
Adventure Journal sheet as part of their end-of-
Scene Bookkeeping. Then they look over their Lists
...
FOR A SOLO
ADVENTURE
Getting your act together to run a solo role-
playing session can be just as individualized as the
...
Yes The value is what you expect.
EXCEPTIONAL
YES
The value is higher than you
expect, by about 25%.
NO The value is lower than you
expect, by about 25%.
EXCEPTIONAL
NO
...
use the weaponry from an RPG about space-
...
✘
✘
✘You can record Progress Points at any time,whether during the Scene as you play or after
...
“IS SOMETHING
DISCOVERED?”
YES Roll on the ThreadDiscovery Check Table.
NO
...
The Player interprets the results this way: Re-
reading her books, the mage discovers a story she
...
18 Flashpoint +3
19 Track +2
20-24 Strengthen Progress +1
25+ Strengthen Progress +2
137137
VARIATIONS
...
We know the mage hunting the manna-
thieving imp won’t capture it in the apartment
...
SSUPERUPERBBREAKERSREAKERS!!
A Game Of Super Mayhem ByA Game Of Super Mayhem ByA. U. THORA. U. THOR
...
CHECK THE FATE CHART: Check the
...
Exceptional No.
RANDOM EVENT: If you rolled a double
```
...
Likely, Nearly Certain, Certain, Unlikely, Very
Unlikely, Nearly Impossible, or Impossible.
GET MODIFIERS: Determine modifiers
for the Odds and the Chaos Factor, adding
them together.
ROLL 2D10: Roll 2d10, adding them together
...
instead of rolling.
DETERMINE EVENT MEANING: Choose
...
```
INTERPRET: Combining the adventure
```
...
d8, or d10.
```
ROLL: If necessary, roll the die to determine
```
a section. Then roll a 1d10 to determine an
element in that section.
```
CHOOSE: If you roll an empty line then you
```
...
an adventure.
INSPIRED IDEA: Come up with an idea
rather than determining randomly.
RANDOM EVENT: Generate a Random
Event to form the start of the Scene.
MEANING TABLES: Choose Meaning
Tables and roll as many word pairs as you need
for inspiration.
187187
RULES SUMMARY
4W: Roll on the Meaning Tables in a
structured way to get the Who, What, Where,
and Why of a Scene.
- Who: Characters Elements Meaning
Table.
- What: Actions Meaning Tables.
- Where: Locations Elements Meaning
Table.
- Why: Actions Meaning Tables.
Testing Scenes
EXPECTED SCENE: Decide how you
think the next Scene will begin. This is the
Expected Scene.
ROLL 1D10: Roll 1d10 to test the Expected
...
THE NEXT EXPECTATION: This is the
default method. The Scene is what you would
next most expect.
A TWEAK: Change one element in the
Expected Scene.
FATE QUESTION: Ask a Fate Question to
help you choose how the Scene changes.
MEANING TABLES: Choose a Meaning
Table and roll for a word pair as inspiration.
SCENE ADJUSTMENT TABLE: Roll 1d10
...
```
EXPECTATIONS: If you have a clear idea
```
...
End Of Scene Bookkeeping
EDIT LIST ELEMENTS: Add new Threads
...
ADJUST THE CHAOS FACTOR: If the
...
TRACK FLASHPOINT: If you reach enough
...
DISCOVERY CHECK: Make a Discovery
...
less than 50/50.
- Yes: Roll on the Thread Discovery
Check Table.
- No: Nothing useful is found.
...
PLOT ARMOR: The Focus Thread cannot be
...
```
CONCLUSION: When the Progress Track
```
...
FIRST SCENE: Create a first Scene based off
of how the prepared adventure suggests starting.
PLAY SCENE BY SCENE: Play through the
...
elements in them.
CHOOSE ...: When rolling an empty line on
